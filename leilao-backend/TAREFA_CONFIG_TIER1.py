# ============================================================
# TAREFA AUTÔNOMA: Configuração Tier1
# ============================================================
# Para: Cursor Agent
...
1. Crie o script que analisa sites e gera configs Tier1
2. Execute o script
3. Aguarde análise (~5 minutos para 5 sites)
4. Verifique app/configs/sites/*.json e tier1_analysis_report.json
...
# Salvar o script
script_path = "app/utils/tier1_config_generator.py"
with open(script_path, "w", encoding="utf-8") as f:
    f.write(CODIGO_ANALYZER)

print(f"Arquivo criado: {script_path}")

# Executar diretamente
print("\nExecutando analise Tier1...\n")

# Importar e executar
exec(CODIGO_ANALYZER.replace("if __name__ == \"__main__\":", "if True:"))
