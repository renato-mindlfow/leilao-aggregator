# ============================================================
# TAREFA AUTÔNOMA: Análise Profunda de Sites
# ============================================================
# Para: Cursor Agent
...
1. Crie o arquivo app/utils/deep_site_analyzer.py com o código abaixo
2. Execute o script
3. Aguarde análise (~10 minutos para 5 sites)
4. Verifique site_analysis/
...
# ============================================================
# CÓDIGO PARA CRIAR EM: app/utils/deep_site_analyzer.py
# ============================================================
...
# Salvar o script
script_path = "app/utils/deep_site_analyzer.py"
with open(script_path, "w", encoding="utf-8") as f:
    f.write(CODIGO_ANALYZER)

print(f"Arquivo criado: {script_path}")
print(f"\nPara executar:")
print(f"  python -m app.utils.deep_site_analyzer")
