# ============================================================
# TAREFA AUTÔNOMA: Scraper Configurável
# ============================================================
# Para: Cursor Agent
...
1. Crie o arquivo app/scrapers/configurable_scraper.py com o código abaixo
2. Execute o script
3. Aguarde scraping (~10 minutos para 4 sites)
4. Verifique extracted_properties.json e extracted_properties.csv
...
# ============================================================
# CÓDIGO PARA CRIAR EM: app/scrapers/configurable_scraper.py
# ============================================================
...
# Salvar o script
script_path = "app/scrapers/configurable_scraper.py"
with open(script_path, "w", encoding="utf-8") as f:
    f.write(CODIGO_SCRAPER)

print(f"Arquivo criado: {script_path}")
print(f"\nPara executar:")
print(f"  python -m app.scrapers.configurable_scraper")
